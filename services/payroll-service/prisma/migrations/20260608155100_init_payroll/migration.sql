...
CREATE TABLE "bank_payment_files" (
    ...
    CONSTRAINT "bank_payment_files_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "payroll_configurations_tenant_id_idx" ON "payroll_configurations"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "payroll_configurations_tenant_id_client_id_key" ON "payroll_configurations"("tenant_id", "client_id");

-- CreateIndex
CREATE INDEX "employees_tenant_id_idx" ON "employees"("tenant_id");

-- CreateIndex
CREATE INDEX "employees_tenant_id_client_id_idx" ON "employees"("tenant_id", "client_id");

-- CreateIndex
CREATE INDEX "employees_tenant_id_employment_status_idx" ON "employees"("tenant_id", "employment_status");

-- CreateIndex
CREATE INDEX "employee_contracts_tenant_id_idx" ON "employee_contracts"("tenant_id");

-- CreateIndex
CREATE INDEX "employee_contracts_employee_id_idx" ON "employee_contracts"("employee_id");

-- CreateIndex
CREATE INDEX "employee_contracts_tenant_id_status_idx" ON "employee_contracts"("tenant_id", "status");

-- CreateIndex
CREATE INDEX "payroll_periods_tenant_id_idx" ON "payroll_periods"("tenant_id");

-- CreateIndex
CREATE INDEX "payroll_periods_tenant_id_client_id_idx" ON "payroll_periods"("tenant_id", "client_id");

-- CreateIndex
CREATE INDEX "payroll_periods_tenant_id_status_idx" ON "payroll_periods"("tenant_id", "status");

-- CreateIndex
CREATE UNIQUE INDEX "payroll_periods_tenant_id_client_id_period_month_period_yea_key" ON "payroll_periods"("tenant_id", "client_id", "period_month", "period_year");
...
-- CreateIndex
CREATE UNIQUE INDEX "payroll_records_period_id_employee_id_key" ON "payroll_records"("period_id", "employee_id");

-- CreateIndex
CREATE INDEX "payroll_approvals_period_id_idx" ON "payroll_approvals"("period_id");

-- CreateIndex
CREATE INDEX "bank_payment_files_period_id_idx" ON "bank_payment_files"("period_id");
