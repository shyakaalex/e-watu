...
import { PersonalKpisPage } from './pages/payroll/PersonalKpisPage';
import { TeamKpisPage } from './pages/payroll/TeamKpisPage';
  ...
  return (
    <>
      ...
      >
        ...
        <Route path="kpis" element={<PersonalKpisPage />} />
